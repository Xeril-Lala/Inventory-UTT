...
SELECT
    ...
    A.KEY1 LOCATION_GROUP, A.KEY2 LOCATION_SGROUP,
    ...
    IS_INVENTORY_USED(I.INVENTORY_ID) IS_USED
FROM
...
SELECT
    ...
    VL.DURATION_UNIT, VL.DURATION,

    -- VL.DESCRIPTION LOAN_DESC,
    ...
    -- VI.LOCATION_CODE INVENTORY_LOCATION,

    VI.LOCATION_CODE, VI.LOCATION_VALUE,
    VI.LOCATION_GROUP, VI.LOCATION_SGROUP,
    VI.LOCATION_AGROUP, VI.LOCATION_DESCRIPTION,
