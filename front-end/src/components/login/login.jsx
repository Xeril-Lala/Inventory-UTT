...
import SecurityService from '../../services/scurity';
...
function auth() {
  request.authLogin(
    'DEV', 
    '955e581504f103fdfa874f6739eff8aa0874ddbb27da5a623175e9b49d958a13',
    res => {
      console.log(res);
    }
  );
    ...
    <section class=" pt-20  flex items-center justify-center">
      <div class="flex rounded-md shadow-lg max-w-3xl p-5 items-center bg-white">
        <div class="md:w-1/2 px-8 md:px-16">
          <h2 class="font-normal text-2xl text-[#4d0f1c]">Inicar Sesión</h2>
          ...
          <form action="" class="flex flex-col gap-4 text-sm">
            ...
            <button onClick={auth} class="bg-[#4d0f1c] rounded-md text-white py-2 hover:scale-105 duration-300">Login</button>
          </form>
